...
<div class="menu-filter">
    <ul>
        <li>
            <a href="<?php echo base_url(); ?>manager/list?table=<?php echo $table.$rear; ?>" <?php if (!isset($_GET['show'])) {
                echo 'class="active"';
            } ?> >Tất cả</a>
        </li>
        <li>
            <a href="<?php echo base_url(); ?>manager/list?table=<?php echo $table.$rear; ?>&show=1" <?php if (!empty($_GET['show'])) {
                if ($_GET['show'] == 1) {
                    echo 'class="active"';
                }
            } ?> >Đã xuất bản</a>
        ...
        <li>
            <a href="<?php echo base_url(); ?>manager/list?table=<?php echo $table.$rear; ?>&show=0" <?php if (isset($_GET['show'])) {
                if ($_GET['show'] == 0) {
                    echo 'class="active"';
                }
            } ?> >Chưa xuất bản</a></li>
...
<div class="menu-option">
    <ul>
        <?php if (Check_per_action($table, $iduser, 1)) { ?>
            <li class="option-item"><a class="option-add" href="<?php echo base_url(); ?>manager/add?table=<?php echo $table; ?>"><i class="glyphicon glyphicon-plus"></i><span>Tạo sản phẩm mới</span></a>
            </li>
        <?php } ?>
    ...
    <div class="list-item">
        <table class="table table-contact table-list table-hover">
            ...
            <tr>
                ...
                <th style="line-height:35px;">Ảnh</th>
                ...
                <th style="line-height:35px;"class="text-center">Nhân viên</th>
                <th style="line-height:35px;"class="text-center">Nhân bản</th>
            </tr>
            </thead>
            <tbody>
            <?php $order_id=0; foreach ($object_item as $obj) { ?>
                <tr>
                    ...
                    <td>
                        <img src="<?php echo $obj->image;?>" alt="" width="50px">
                    </td>
                    <td class="box-title-edit">
                        <a id="title_<?php echo $obj->id;?>" href="<?php if (Check_per_action($table, $iduser, 2)) {
                            ; ?><?php echo base_url(); ?>manager/edit?table=<?php echo $this->input->get('table'); ?>&id=<?php echo $obj->id.$rear.$page; ?><?php } else {
                    ...
                    <td  style="line-height:30px;" class="text-center"><?php $user_post = $this->Common_model->get_one('users',array('id'=>$obj->iduser));
                        if(!empty($user_post)){echo $user_post->username; }
                        ?> </td>
                    <td>
                        <button class="btn btn-add btn-update" data-id="<?php echo $obj->id; ?>" type="button">Nhân bản
                        </button>
                    </td>
                </tr>
                <!-- end row item-->
