    ...
    <ul>
        <?php if(Check_per_action($table,$iduser,1)){?>
            <li class="option-item"><a class="option-add"
                                       href="<?php echo base_url(); ?>manager/add?table=<?php echo $table; ?>"><span>Tạo bài viết mới</span></a>
            </li>
        <?php }?>
        ...
        <li class="option-item item-list-status"><a
            ...
            <ul class="ul-list cookie-name" cookie_name="content_list_service" catid="allsearch_text"
                ...
                <li><span class="tick-active">Tên sự kiện</span></li>
    ...
    <div class="list-item">
        <table class="table table-contact table-list">
            ...
            <tr>
                ...
                <th style="line-height:35px;">Tên sự kiện</th>
                <th style="line-height:35px;" class="text-center">Ngày tổ chức</th>
                <th style="line-height:35px;" class="text-center">Địa chỉ</th>
            </tr>
            </thead>
            <tbody>
            <?php foreach ($object_item as $obj) { ?>
                <tr>
                    ...
                    <td class="text-center">
                        <?php  echo date('d-m-Y',strtotime($obj->day_start)) ; ?>
                    </td>
                    <td>
