    ...
    <div class="list-item">
        <table class="table table-contact table-list table-hover">
            ...
            <tr>
                ...
                <th style="line-height:35px;">Vị trí</th>
            ...
            <?php $order_id=0; foreach ($object_item as $obj) { ?>
                <tr>
                    ...
                    <td>
                        <?php if($obj->type==1){echo 'Video';}else if($obj->type==0){echo 'Thương hiệu';}else{echo 'Thư viện ảnh';} ?>
                    </td>
                    <td>
                        <?php if($obj->position==0){echo 'Thương hiệu';}else if($obj->position==1){echo 'Flashsale phải';}else if($obj->position==2){echo 'Danh mục bài viết';}else{echo 'Danh mục sản phẩm';} ?>
                    </td>
