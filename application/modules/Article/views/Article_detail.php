    ...
    <section class="bread-crumb breadcrumb-article ">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="<?php echo base_url() . $article->alias; ?>"
                       title="<?php echo show_meta($article); ?>">
                        ...
                        <div class="article-details">
                            ...
                            <div class="row">
                                <div class="col-12 ">
                                    ...
                                    <script type="text/javascript" language="javascript"
                                            src="<?php echo base_url('skin/frontend'); ?>/js/rating1.js"></script>
                                    <link rel="stylesheet" type="text/CSS"
                                          href="<?php echo base_url('skin/frontend'); ?>/css/rating.css?<?php echo time();?>"/>
                                    <div class="voting" >
                                        <?php echo Modules::run('Article/Module_article/rating_bar', $art->id); ?></div>
                                </div>
                                <div class="col-12">
                                    <div class="date">
                                        <div class="news_home_content_short_time">
                                            ...
                                            <span>
                                <?php echo rebuild_date('l', strtotime($article->date_create)); ?>
                                                            ,<?php echo date('d/m/Y', strtotime($article->date_create)); ?>
                                </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="article-content">
                                <div class="rte">
                                    ...
                                    <?php echo $article->content_text; ?>
                                    <script src="<?php echo base_url(); ?>skin/frontend/js/toc/jquery.toc.js?<?php echo time(); ?>"></script>
                                    <!--<script src="-->
                                    <?php //echo base_url();?><!--skin/frontend/js/toc/toc.js?-->
                                    <?php //echo time(); ?><!--"></script>-->
                                    <script type="text/javascript">
                                        var options = {
                                            selector: 'h2, h3, h4, h5, h6',
                                            scope: '.rte',
                                            prefix: '<?php echo $article->alias; ?>'
                                        };
                                        ...
                                        $(document).on('click', 'a[href^="#"]', function (event) {
                                            ...
                                            $('html, body').animate({
                                                scrollTop: positionsr.top - $('header').outerHeight() - 30
                                            }, 100);
                                        });
                        ...
                        <div class="blog-aside aside-item">
                            <div>
                                <div class="aside-title-blog">
                                    <h2 class="title-head-blog"><span><a
                                                    href="<?php echo base_url(); ?>">Bài viết liên quan</a></span>
                                    </h2>
                                </div>
                                                    ...
                                                    <div class="reviews-product-grid">
                                                        <div class="bizweb-product-reviews-badge"
                                                            ...
                                                            <div class="bizweb-product-reviews-star"
                                                                 ...
                                                                 style="color: rgb(255, 190, 0);"><?php $star = $objPr->star; $none_star= 5 - $objPr->star; ?>
