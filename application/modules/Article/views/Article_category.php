                ...
                <div class="col-sm-9 left-content">
                    <div class="list-blogs blog-main">
                        <?php foreach ($article as $art) { ?>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col count">
                                                        ...
                                                        <div class="content-right-blog">
                                                            ...
                                                            <span class="fix_left_blog">
                                                                ...
                                                                <svg aria-hidden="true" focusable="false"
                                                                     ...
                                                                     viewBox="0 0 448 512"
                                                                     class="svg-inline--fa fa-calendar-alt fa-w-14 fa-3x"><path
                                                                            fill="currentColor"
                                                            ...
                                                            <p class=" text2line blog-item-summary">
                                                                <?php echo character_limiter(strip_tags($art->introtext)); ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
