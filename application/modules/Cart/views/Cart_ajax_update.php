        ...
        <?php if ($this->cart->contents()) {
            ...
            foreach ($this->cart->contents() as $item) {
                ...
                <div class="item-popup productid-<?php echo $proCart->id; ?>">
                    ...
                    <div style="width: 14.4%;" class="border-cart height text-center">
                        <div class="item-price"><span class="price"><?php echo VndDot($item['price']); ?>₫</span></div>
                    </div>
                    <div style="width: 14.5%;" class="border-cart height text-center">
                    ...
                    <div style="width: 20.3%;" class="border-cart height text-center"><span
